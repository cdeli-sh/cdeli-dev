...
export default function Hacked() {
    return (
        <div className='h-screen w-screen relative flex flex-col items-center justify-center bg-black'>
            ...
            {">"} Attention, en retrant tes infos personnelles sans vérifier que le site sur lequel tu es est fiable, tu peux potentiellement permettre à des personnes malveillantes de prendre en otage ton compte discord. Ne fais plus jamais ça, <br/>d{"'"}accord ?
            </p>
